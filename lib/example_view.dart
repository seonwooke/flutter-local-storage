...
class ExampleView extends StatelessWidget {
  ...
  _bodyWidget() {
    return ValueListenableBuilder /* Hive 제공 위젯 */ (
      valueListenable: Hive.box<PersonModel>('AttendanceBook').listenable(),
      builder: (context, Box<PersonModel> box, child) {
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () {
                        ...
                        box.put(
                            id, PersonModel(id: id, name: nameController.text));
